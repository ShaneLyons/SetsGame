/**
 * Ripped from: http://wiki.unity3d.com/index.php/LineRenderer_Rope
 * There are a few tweakable values, but only mass and drag seem to really matter.
 * Those values have to be carefully set because otherwise the rope goes haywire.
 */
